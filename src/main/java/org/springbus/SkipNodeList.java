...
public class SkipNodeList<T extends Comparable<? super T>> {
    ...
    public static void main(String[] args) {
        SkipNodeList<Integer> skipNodeList = new SkipNodeList();
        skipNodeList.insert(10);

        skipNodeList.insert(20);
        skipNodeList.insert(15);
        skipNodeList.insert(16);
        skipNodeList.insert(13);

        int v = skipNodeList.search(16);
        int l = skipNodeList.root.length;
        SkipListNode<Integer>[] t = skipNodeList.root;
        for (int i = 0; i < l; i++) {
            SkipListNode<Integer> next = t[i];
